...
#define SECUENCE_FOR_SPECIAL_MOVE_0 "LHJ"
#define SECUENCE_FOR_SPECIAL_MOVE_1 "LKP"
#define SECUENCE_FOR_SPECIAL_MOVE_2 "UDJ"
#define SECUENCE_FOR_SPECIAL_MOVE_3 "KKKK"

#define FALATITY_NUMBER_SPECIAL_MOVE 3
